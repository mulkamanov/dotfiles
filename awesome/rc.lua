...
awful.util.browser = browser
awful.util.guieditor = guieditor
...
-- https://github.com/pw4ever/awesome-wm-config/blob/awesome-4.x/rc.lua
...
customization.func.volume_up = function ()
    os.execute(string.format("amixer -q set %s 5%%+", beautiful.volume.channel))
    beautiful.volume.update()
end

customization.func.volume_down = function ()
    os.execute(string.format("amixer -q set %s 5%%-", beautiful.volume.channel))
    beautiful.volume.update()
end

customization.func.volume_toggle = function ()
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey, altkey, "c" }, "Right", function () if beautiful.cal then beautiful.cal.next() end end,
              {description = "calendar next month", group = "widgets"}),
    awful.key({ modkey, altkey, "c" }, "Left", function () if beautiful.cal then beautiful.cal.prev() end end,
              {description = "calendar previous month", group = "widgets"}),
    ...
    -- ALSA volume control
    awful.key({ modkey }, "Up", customization.func.volume_up,
              {description = "volume up", group = "hotkeys"}),
    awful.key({ }, "XF86AudioRaiseVolume", customization.func.volume_up,
              {description = "volume up", group = "hotkeys"}),
    awful.key({ modkey }, "Down", customization.func.volume_down,
              {description = "volume down", group = "hotkeys"}),
    awful.key({ }, "XF86AudioLowerVolume", customization.func.volume_down,
              {description = "volume down", group = "hotkeys"}),
    awful.key({ }, "XF86AudioMute", customization.func.volume_toggle,
...
clientkeys = my_table.join(
    ...
    awful.key({ modkey, "Control" }, "b", awful.titlebar.toggle,
